          ...
          <Card className="relative bg-black/80 backdrop-blur-md border-0 shadow-2xl">
            <CardContent className="p-8 space-y-6">
              <form className="space-y-5">
                ...
                <div className="space-y-3">
                  <Label htmlFor="Firstname" className="text-cyan-300 font-mono text-xs tracking-[0.2em] uppercase">
                    Fullname
                  </Label>
                  <Input
                    id="Fullname"
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Label 
                    htmlFor="professor" 
                    className="text-cyan-300 font-mono text-xs tracking-[0.2em] uppercase cursor-pointer"
                  >
                    SIGNUP AS PROFESSOR
                  </Label>
                </div>
